                          ...
                          <div class="mb-3 col-4 col-sm-auto col-md-auto">
                            ...
                            <div class="mb-3">
                                ...
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtPass" ErrorMessage="⛔ El campo Contraseña es requerido" CssClass="text-danger" Display="Dynamic" />
                                 <asp:RegularExpressionValidator ControlToValidate="txtPass" ValidationExpression="^(?=.*[A-Z])(?=.*\d)[A-Za-z\d]{6,}$" ErrorMessage="⛔ La contraseña debe contener al menos 6 caracteres, incluir una letra mayúscula y un número" CssClass="text-danger" Display="Dynamic" runat="server" />
                            </div>
