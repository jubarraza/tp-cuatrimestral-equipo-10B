<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="Paises.aspx.cs" Inherits="App_GestorIncidencias.Admin.Paises" %>
        ...
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                <div class="row justify-content-center">
                    ...
                    <div>
                        <asp:GridView ID="gvPaises" runat="server" DataKeyNames="Id"
                            CssClass="table transparent-grid border-black" AutoGenerateColumns="false" OnSelectedIndexChanged="gvPaises_SelectedIndexChanged" OnRowDeleting="gvPaises_RowDeleting" >
                            <Columns>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="ModalLabel">⛔ Eliminar Pais</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>¿Confirma que desea eliminar el Pais?</p>
                </div>
