                ...
                <div class="row justify-content-center">
                    ...
                    <div>
                        <asp:GridView ID="gvPrioridades" runat="server" DataKeyNames="Id"
                            CssClass="table transparent-grid border-black" AutoGenerateColumns="false" OnSelectedIndexChanged="gvPrioridades_SelectedIndexChanged" OnRowDeleting="gvPrioridades_RowDeleting">
                            <Columns>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="ModalLabel">⛔ Eliminar Prioridad</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p>¿Confirma que desea eliminar la Prioridad?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                <asp:Button Text="Eliminar Prioridad" CssClass="btn btn-danger" ID="btnEliminarConfirmado" OnClick="btnEliminarConfirmado_Click" runat="server" />
            </div>
        </div>
    </div>
</div>
