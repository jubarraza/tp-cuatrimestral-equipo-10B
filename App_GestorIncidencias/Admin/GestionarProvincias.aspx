<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="GestionarProvincias.aspx.cs" Inherits="App_GestorIncidencias.Admin.GestionarProvincias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-5 border border-black rounded pt-3 col-lg-5 col-xxl-3 col-sm-auto">
        ...
        <div class="row justify-content-center">
            ...
            <div class="mb-3">
                <label for="txtNombre" class="form-label">Provincia</label>
                <asp:TextBox runat="server" ID="txtNombre" CssClass="form-control" MaxLength="50" />
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtNombre" ErrorMessage="⛔ El campo Provincia es requerido" CssClass="text-danger" Display="Dynamic" />
            </div>

            <div class="mb-3">
                <label for="ddlPaises" class="form-label">Pais</label>
